                        ...
                        <div>
                            <?php foreach ($projeto->categorias as $categoria): ?>
                                <p style="display: inline-block"
                                   class="text-categorias-bg-grey"><?= $categoria->nome ?></p>
                            <?php endforeach; ?>
                        </div>
                        <?= $this->Html->link(
    ...
    <nav aria-label="Navegação de páginas">
        <ul class="pagination">
            ...
            <?= $this->Paginator->numbers([
                ...
                'modulus' => 3,
                'templates' => [
                    'number' => '<li class="page-item {{class}}"><a class="page-link page-link-pill" href="{{url}}">{{text}}</a></li>',
                    'current' => '<li class="page-item active"><a class="page-link page-link-pill bg-primary text-white" href="#">{{text}}</a></li>'
                ]
            ]) ?>
