...
class FuncoesController extends AppController
{
    ...
    {
        $funco = $this->Funcoes->get($id, contain: ['Projetos', 'Habilidades', 'Usuarios']);
    ...
    public function add()
    {
        ...
        $habilidades = $this->Funcoes->Habilidades->find('list', limit: 200)->all();
        $usuarios = $this->Funcoes->Usuarios->find('list', limit: 200)->all();
        $this->set(compact('funco', 'projetos', 'habilidades', 'usuarios'));
    }
    ...
    {
        $funco = $this->Funcoes->get($id, contain: ['Habilidades', 'Usuarios']);
